def Y3(z1, z2, z3, z4, z5):
    ...
    E3=tk.Entry(C, width=30, font="Calibri")
    E3_window = canvas.create_window(250, 245, window=E3)
    E3.configure(border=2)

    l3=tk.Label(C, text="ADD BALANCE:", width=16, relief="sunken")
    ...
    def next():
        ...
        if E1.get()!="" and E2.get()!="" and E3.get()!="":
            ...
            if flag==0:
                ...
                a=("UPDATE bank SET BALANCE=BALANCE+"+str(E3.get())+" WHERE LOGIN_ID='" + str(E1.get()) + "' AND PASSWORD='" + str(E2.get()) +"'")
                ...
                B=tk.Button(l, text="OK", width="15", relief="groove", bg="black", fg="white", command=ok)
                B.configure(border=1)
                L=tk.Label(l, text="Amount Credited.", bg="black", fg="white")
                L.pack()
                B.pack()
