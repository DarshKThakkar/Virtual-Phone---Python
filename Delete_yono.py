def Y2(z1, z2, z3, z4, z5):
    ...
    def next():
        ...
        if E1.get()!="" and E2.get()!="":
            ...
            if flag==0:
                ...
                a=("DELETE FROM bank WHERE LOGIN_ID='" + str(E1.get()) + "' AND PASSWORD='" + str(E2.get()) +"'")
                ...
                B=tk.Button(l, text="OK", width="15", relief="groove", bg="black", fg="white", command=ok)
                B.configure(border=1)
                L=tk.Label(l, text="Account Removed.", bg="black", fg="white")
                L.pack()
                B.pack()
    ...
    b2=tk.Button(C, text="DELETE", width=13, relief="groove", command=next)
